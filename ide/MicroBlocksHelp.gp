...
method initialize MicroBlocksHelp {
	...
	opEntries = (array
		...
		(array '_REX Arm new default base' '/extension_libraries/rex/#_rex-arm-new-default' 'Sets DEFAULT values for the Arm servos.')
		(array '_REX Arm new maximum base' '/extension_libraries/rex/#_rex-arm-new-max' 'Sets MAXIMUM values for the Arm servos.')
		(array '_REX Arm new minimum base' '/extension_libraries/rex/#_rex-arm-new-min' 'Sets MINIMUM values for the Arm servos.')
