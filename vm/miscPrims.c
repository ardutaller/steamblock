...
// static const uint8 fontAdafruit[95 * 5] = {
...
static OBJ primShapeforChar(int argCount, OBJ *args) {
	...
	const uint8 *font = fontDUELink; // xxx
// xxx
// if ((argCount > 1) && isInt(args[1]) && (1 == obj2int(args[1]))) {
//   font = fontAdafruit;
// }
	...
	const uint8 *src = &font[fontWidth * (ascii - 32)];
